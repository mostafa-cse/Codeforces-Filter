...
export default function CodeforcesFilter() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch contests for dates and categories
  ...
  const activeFilterCount = useMemo(() => {
    ...
    if (filters.ratingMin > 0 || filters.ratingMax < 5000) count++;
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside 
          className={`
            ...
            md:translate-x-0
            ${sidebarOpen ? 'w-[280px] md:block' : 'hidden'}
            fixed md:relative
            top-14 md:top-0
            left-0
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="border border-cf-border rounded-lg overflow-hidden">
              ...
              >
                ...
                {(filters.ratingMin > 0 || filters.ratingMax < 5000) && (
                  <span className="px-2 py-0.5 bg-cf-accent text-white text-xs rounded-full">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        onChange={(e) => setFilters({ ...filters, ratingMin: parseInt(e.target.value) || 0 })}
                        className="w-full px-3 py-2 bg-cf-bg border border-cf-border rounded-lg text-sm focus:border-cf-accent focus:outline-none"
                        placeholder="0"
                      />
                    </div>
                    ...
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        onChange={(e) => setFilters({ ...filters, ratingMax: parseInt(e.target.value) || 5000 })}
                        className="w-full px-3 py-2 bg-cf-bg border border-cf-border rounded-lg text-sm focus:border-cf-accent focus:outline-none"
                        placeholder="5000"
                      />
                    </div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        onChange={(e) => setFilters({ ...filters, solvedMin: parseInt(e.target.value) || 0 })}
                        className="w-full px-3 py-2 bg-cf-bg border border-cf-border rounded-lg text-sm focus:border-cf-accent focus:outline-none"
                        placeholder="0"
                      />
                    </div>
                    ...
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        onChange={(e) => setFilters({ ...filters, solvedMax: parseInt(e.target.value) || 10000000 })}
                        className="w-full px-3 py-2 bg-cf-bg border border-cf-border rounded-lg text-sm focus:border-cf-accent focus:outline-none"
